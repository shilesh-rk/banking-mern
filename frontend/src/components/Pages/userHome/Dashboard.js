    ...
    <>
      <div>
        <div className='container'>
          ...
          {/* {user?
        <div className="container rounded-5 icons d-flex justify-content-center">
        <div>
        <Link to="/userProfile" className="h-100 my-profile w-100 bg-body-secondary mt-2  icon-border user-icons" ><i className="fa-solid font-icon fa-user fs-1"></i></Link>
        <p className='text-center fw-bold'>My Profile</p>
        </div>
        <div>
        <Link to={`/addmoney/${user._id}`} className="h-100 add-money bg-body-secondary mt-2 d-flex justify-content-center align-items-center icon-border user-icons"><i className="fa-solid font-icon fa-wallet fs-1"></i></Link>
        <p className='text-center fw-bold'>Add Money</p>
        </div>
        <div>
        <Link to={`/transfer` }className="h-100 transfer-money bg-body-secondary mt-2 d-flex justify-content-center align-items-center icon-border user-icons"><i className="fa-solid font-icon fa-money-bill-transfer fs-1"></i></Link>
        <p className='text-center fw-bold'>Transfer</p>
        </div>
        <div>
        <Link to="/allaccounts" className="h-100 history bg-body-secondary mt-2 d-flex justify-content-center align-items-center icon-border user-icons"><i className="fa-solid font-icon fa-users fs-1"></i></Link>
            ...
            <div className='container alerts'>
              <div className='row mt-2'>
                <div className='col-md-6'>
                  ...
                  <p className="fa-solid text-success fa-circle-check check "><span className="points">The URL in your browser address bar begins with "https".</span></p>
                  <p className="fa-solid text-success fa-circle-check check "><span className="points">The address or status bar displays the padlock symbol.</span></p>
                  <p className="fa-solid text-success fa-circle-check check "><span className="points">Click the padlock to view and verify the security certificate.</span></p>
                  <p className="fa-solid text-success fa-circle-check check d-flex justify-content-evenly"><span className="points">The address bar turns green indicating that the site is secured  with an SSL Certificate that meets the Extended Validation Standard..</span></p>
                  <p className="fa-solid text-success fa-circle-check check "><span className="points">The URL in your browser address bar begins with "https".</span></p>
                </div>

                <div className='col-md-6'>

                  <p className="fa-solid text-success fa-circle-check check d-flex justify-content-evenly"><span className="points">Phishing is a fraudulent attempt, usually made through email, phone calls, SMS etc seeking your personal and confidential information.</span></p>
                  <p className="fa-solid text-success fa-circle-check check d-flex justify-content-evenly"><span className="points">BigBank or any of its representative never sends you email/SMS or calls you over phone to get your personal information,password or one time SMS (high security) password. Any such e-mail/SMS or phone call is an attempt to fraudulently withdraw money from your account through Internet Banking. Never respond to such email/SMS or phone call. Please report immediately on report.phishing@bb.co.in if you receive any such email/SMS or Phone call. Please lock your user access immediately, if you have accidentally revealed your credentials.Click here to lock.</span></p>
